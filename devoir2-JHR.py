...
for chaque in lobbies["registre"]: 
    ...
    objet = chaque [1][0]["objet"] ### ATTENTION: ICI, TU NE RECUEILLES QUE LE PREMIER OBJET DE LOBBYING; IL PEUT Y EN AVOIR PLUSIEURS
...
### TU AS FAIT ROULET TON SCRIPT 6 FOIS, ON DIRAIT, CAR TON CSV CONTIENT 6 FOIS PLUS DE LIGNES QUE CE QUE J'AI OBTENU QUAND JE L'AI FAIT ROULER MOI-MÊME
